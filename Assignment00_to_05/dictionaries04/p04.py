...
def login(email, stored_logins, password_to_check):
    ...
    # Compare the hashed password from the input to the stored hashed password
...
def hash_password(password):
    ...
    """
    # Create a SHA256 hash of the password and return the hex digest (hashed password)
...
def main():
    ...
    stored_logins = {
        ...
        "student@stanford.edu": "882c6df720fd99f5eebb1581a1cf975625cea8a160283011c0b9512bb56c95fb"  # hashed 'password'
    }
